...
public class SewaBadmintonApp {
    private static Connection connect() {
        try {
            return DriverManager.getConnection("jdbc:mysql://localhost:3306/sewa_badminton", "root", "rootpassword");
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("Sewa Lapangan Badminton");
